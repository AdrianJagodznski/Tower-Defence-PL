...
new g_SkillsDesc[MAX_LEVEL][64] = 
{
	...
	"Jestes 25% szybszy.",
	"Zadajesz 16 DMG wiecej",
	"Dostajesz 1 granat zamrazajacy co 2 min.",
	"Mozesz strzelic laserem co 30 sec. 'X'"
}
...
public CmdGoToSpec(id)
{
	...
	if(!is_user_alive(id))
	{
		ColorChat(id, GREEN, "%s^x01 Musisz byc zywy aby uzyc tej komendy", CHAT_PREFIX);
		return PLUGIN_HANDLED;
	}
